            ...
            <div class="text_content">
                <div v-for="(item, index) in HoverText" :key="index" class="item_text_content">
                    <div class="item_text_one">
                        ...
                        <!-- <div class="item_text_num">{{ number }}</div> -->
...
const startAutoIncrement = (startNum, endNum, speed, endTime) => {
    ...
    intervalId(startNum, endNum, speed, endTime, addNum)
};
// 封装数据增长方法
const intervalId = (startNum, endNum, speed, endTime, addNum) => {
    setInterval(() => {
        startNum.value += addNum
...
const mouseoverCarousel = () => {
    isView.show = true
    startAutoIncrement(num1, 80000, 300, 10)
